class CommentsController < ApplicationController
  ...
  def create
    ...
    @comment.startup_id = params[:startup_id]
    @comment.founder_id = params[:founder_id]
    @comment.venturefund_id = params[:venturefund_id]
    @comment.partner_id = params[:partner_id]
